...
def main():
    ...
    if st.session_state.validasi:    
        ...
        "Analisis harga pertanian Thailand dan faktor pendorong di balik dinamika harga.",
            ...
            """Nasi\n
            Nasi merupakan Makanan yang paling banyak dikonsumsi dan bagian penting dari masakan Thailand. Satu hal yang pasti, Anda tidak akan menemukan penduduk lokal yang makan tanpa nasi! Makanan ini dianggap memiliki jiwa tersendiri yang menyoroti pentingnya dalam budaya negara ini.
            ...
            """Kualitas Terbaik, Beras Terbaik Kami\n
        ...
        #### ---- RICE ---- ####
            ...
            fact = st.selectbox("Fakta tentang Tanaman Padi di Thailand", ["Select here", "Nasi", "Kualitas Terbaik"])

            if fact == "Nasi":
                st.write("Nasi merupakan Makanan yang paling banyak dikonsumsi dan bagian penting dari masakan Thailand. Satu hal yang pasti, Anda tidak akan menemukan penduduk lokal yang makan tanpa nasi! Makanan ini dianggap memiliki jiwa tersendiri yang menyoroti pentingnya dalam budaya negara ini.")
                st.write("Dilambangkan dengan Ibu Padi, yang lahir dari padi, kemudian hamil dan melahirkan lebih banyak padi, menciptakan siklus kehidupannya sendiri. Keutamaan beras juga ditekankan oleh fakta bahwa nasi adalah makanan pokok. Digunakan sebagai makanan yang dapat disiram dengan berbagai kari dan saus, tetapi juga dapat digunakan untuk membuat aneka masakan lainya.")
            elif fact == "Kualitas Terbaik":
                st.write("Beras melati adalah varietas beras berkualitas premium yang banyak dibudidayakan di Thailand. Namun, diyakini bahwa hanya daerah-daerah tertentu, yang dapat menghasilkan beras berkualitas tinggi. Meskipun hasil panennya lebih rendah dibandingkan dengan jenis beras lainnya, beras melati memiliki harga yang jauh lebih tinggi di pasar global, sering kali dijual dengan harga dua kali lipat lebih tinggi dari harga komoditas beras lainnya.")
        ...
        st.write("Anda Harus - Terlebih Dahulu")
